...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 跟帖管理
    </div>
    <!--面包屑导航 结束-->
                ...
                <table class="list_tab">
                    ...
                    @foreach($follower as $value)
                        <tr>
                            ...
                            <td><a target="_blank" href="{{url('home/topic',$value->topic_id)}}">{{$value->topic->name}}</a></td>
