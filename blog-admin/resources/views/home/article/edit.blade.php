        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    <a href="{{url('home/article/')}}"><i class="fa fa-plus"></i>返回文章列表</a>
                </div>
            </div>
        </div>
        <!--结果集标题与导航组件 结束-->
            ...
            <form method="post" action="{{url('home/article')}}/{{$field->id}}">
                ...
                <table class="add_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <script name="content" id="editor" type="text/plain" style="width:884px;height:500px;" >{!! $field->content !!}</script></td>
                            </tr>
